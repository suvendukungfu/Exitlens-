  ...
  return (
    <div className="pb-12">
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6">
                ...
                {deptCounts.map((d, index) => (
                  <tr
                    ...
                    className={`hover:bg-slate-50/80 transition-colors ${
                      selectedDept === d.name ? 'bg-blue-50/70 font-medium border-l-2 border-l-blue-500' : ''
                    }`}
                  >
                    <td className="p-3.5 font-semibold text-slate-900 flex items-center gap-2.5">
                      ...
                      <span>{d.name}</span>
                      {index === 0 && (
                        <span className="text-[10px] px-2 py-0.5 rounded-full bg-blue-50 border border-blue-200 text-blue-600 font-semibold">
                    ...
                    <td className="p-3.5 text-center text-slate-700 font-mono">
        ...
        <div className="flex items-center justify-between bg-white border border-slate-200/90 p-4.5 rounded-2xl shadow-[0_4px_16px_rgba(15,23,42,0.04)]">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-md border border-blue-200">
              {selectedDept}
            </span>
          </div>
