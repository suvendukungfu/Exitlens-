  ...
  return (
    <div className="bg-slate-950/90 border border-slate-800 rounded-xl p-3 shadow-2xl backdrop-blur-md min-w-42.5">
      ...
      <div className="flex items-center justify-between text-xs gap-3">
        ...
        <span className="font-semibold text-white font-mono">{entry.value} yrs</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="pb-12">
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-slate-900/60 border border-slate-800/80 backdrop-blur-md rounded-xl p-6 shadow-xl space-y-4 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs text-slate-300">
            <div className="bg-slate-950/60 p-4 rounded-xl border border-slate-800/80">
              ...
              <p className="text-slate-400 leading-relaxed">
                Calculated strictly from <code className="text-blue-400 bg-blue-500/10 px-1 py-0.5 rounded font-mono">Joining Date</code> to <code className="text-blue-400 bg-blue-500/10 px-1 py-0.5 rounded font-mono">Last Working Date</code>. If Last Working Date is unrecorded, the <code className="text-blue-400 bg-blue-500/10 px-1 py-0.5 rounded font-mono">Resignation Date</code> is utilized as the operational end marker.
              </p>
            </div>
            ...
            <div className="bg-slate-950/60 p-4 rounded-xl border border-slate-800/80">
              ...
              <p className="text-slate-400 leading-relaxed">
                Values are displayed rounded to a single decimal (e.g. <code className="text-blue-400 bg-blue-500/10 px-1 py-0.5 rounded font-mono">2.8 years</code>) to reflect practical human resource decision-making and prevent misleading false precision.
              </p>
            </div>
