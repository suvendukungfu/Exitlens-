        ...
        <div className="bg-white border border-slate-200 rounded-lg p-5 shadow-2xs space-y-4">
          <div className="flex items-center justify-between flex-wrap gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-slate-300 hover:bg-slate-50 text-xs font-semibold text-slate-700 transition-colors shadow-2xs"
            >
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-5 shadow-2xs space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2.5 pt-1 text-xs">
            {DB_SCHEMA_METADATA.tables.map((t, idx) => (
              <div
                key={t}
                className="p-2.5 rounded border border-slate-200 bg-slate-50/70 flex items-center gap-2"
              >
