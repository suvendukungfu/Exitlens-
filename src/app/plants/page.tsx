    ...
    <div className="bg-white/95 backdrop-blur-xl border border-slate-200 rounded-xl shadow-xl p-3 text-xs text-slate-800 min-w-42.5">
      ...
      {pct !== undefined && (
        <div className="flex items-center justify-between text-xs gap-3 mt-1">
          ...
          <span className="font-medium text-blue-600 font-mono">{pct}%</span>
        </div>
      )}
    </div>
  );
  ...
  return (
    <div className="pb-12">
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6">
          ...
          {plantCounts.map((plant) => {
            ...
            return (
              <div
                ...
                className={`bg-white border rounded-2xl p-4.5 cursor-pointer transition-all shadow-[0_4px_16px_rgba(15,23,42,0.04)] hover:shadow-[0_8px_24px_rgba(15,23,42,0.08)] relative overflow-hidden group ${
                  isSelected
              ...
              >
                ...
                <div className="text-2xl font-bold text-slate-900 mt-1 font-mono tracking-tight">
                  {plant.count} <span className="text-xs font-normal text-slate-500 font-sans">exits</span>
                </div>
        ...
        <div className="flex items-center justify-between bg-white border border-slate-200/90 p-4.5 rounded-2xl shadow-[0_4px_16px_rgba(15,23,42,0.04)] text-xs">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-md border border-blue-200">
              {selectedPlant}
            </span>
          </div>

          <div className="flex items-center gap-5 text-slate-600 font-mono font-medium">
            <span>Voluntary: <span className="text-emerald-600 font-semibold">{selectedMetrics.voluntaryPercentage}%</span></span>
            <span>Median Tenure: <span className="text-slate-900 font-semibold">{selectedMetrics.medianTenureYears} yrs</span></span>
          </div>
        </div>
