  ...
  return (
    <div className="pb-12">
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-slate-900/60 border border-slate-800/80 backdrop-blur-md rounded-xl p-6 shadow-xl flex flex-col md:flex-row md:items-center md:justify-between gap-6 relative overflow-hidden">
          ...
          <div className="flex items-baseline gap-4">
            <div className="text-right">
              ...
              <span className="block text-[11px] font-semibold text-emerald-400 mt-1">
                {dataQualityScore >= 90 ? 'High Integrity' : 'Action Recommended'}
              </span>
            </div>
            <div className="w-28 bg-slate-950/80 border border-slate-800 h-3.5 rounded-full overflow-hidden self-center p-0.5 shadow-inner">
              <div
            ...
            <table className="w-full text-xs text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-800/60">
                {auditResults.issues.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="p-8 text-center text-emerald-400 font-medium">
