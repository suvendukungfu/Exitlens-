  ...
  return (
    <div className="pb-12">
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-[0_4px_16px_rgba(15,23,42,0.04)] flex flex-col md:flex-row md:items-center md:justify-between gap-6 relative overflow-hidden">
          ...
          <div className="space-y-1.5 max-w-xl">
            ...
            <div className="pt-2.5 flex items-center gap-2.5 text-xs">
              <span className="text-slate-500 font-medium">Audit Scope:</span>
          ...
          <div className="flex items-baseline gap-4">
            <div className="text-right">
              ...
              <span className="block text-[11px] font-semibold text-emerald-600 mt-1">
                {dataQualityScore >= 90 ? 'High Integrity' : 'Action Recommended'}
              </span>
            </div>
            <div className="w-28 bg-slate-100 border border-slate-200 h-3.5 rounded-full overflow-hidden self-center p-0.5 shadow-inner">
              <div
        ...
        <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-[0_4px_16px_rgba(15,23,42,0.04)] space-y-5 relative overflow-hidden">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/import"
              className="text-xs text-blue-600 hover:text-blue-700 font-semibold flex items-center gap-1.5 transition-colors"
            >
                ...
                {auditResults.issues.length === 0 ? (
                  ...
                  auditResults.issues.slice(0, 20).map((issue) => (
                    <tr key={issue.id} className="hover:bg-slate-50/60 transition-colors">
                      <td className="p-3.5 font-mono font-medium text-blue-600">
                        {issue.empId || 'N/A'}
                      </td>
